        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if(!$erroPreenchimento && !$erroUpload){
                    ...
                    //Cria uma variável para armazenar a QUERY para realizar a edição dos dados do produto na tabela Produtos
                    $editarProduto = "
                        UPDATE Produtos
                        SET
                    ...
                    //Se conseguir executar a query para update, exibe alerta de sucesso
                    if(mysqli_query($conn, $editarProduto)){
                        header("location:formEditarProduto.php?idProduto=$idProduto&statusEdicao=sucesso");
                        mysqli_close($conn); //Essa função encerra a conexão com o Banco de Dados
                    }
                    else{
                        //Se não conseguir executar a query para update, exibe alerta de erro
                        header("location:formEditarProduto.php?idProduto=$idProduto&statusEdicao=erro");
                    }
                }
            }
            else{
